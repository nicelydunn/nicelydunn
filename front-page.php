                ...
                <div class="md:grid grid-cols-2 gap-16">
                    <div class="md:sticky top-0 self-start pr-20">
                        ...
                        <div class="flex gap-4 mt-8">
                            <div>
                                <a href="https://github.com/nicelydunn?tab=repositories" target="_blank">
                    ...
                    <div class="pt-16"> 
                        ...
                        <?php if ($query->have_posts()) : ?>
                            <?php while ($query->have_posts()) : $query->the_post(); ?>
                                <?php if( get_field('jobs_website_url') ) { echo '<a href="' . get_field('jobs_website_url') . '" target="_blank">'; } ?>
                                    <div class="grid md:grid-cols-4 mt-8">
                        ...
                        <?php if ($query->have_posts()) : ?>
                            ...
                            <?php while ($query->have_posts()) : $query->the_post(); ?>
                                <div class="grid md:grid-cols-5 mt-8 gap-4">
                                    <?php
                                    ...
                                    <div class="col-span-2">
                                        <a href="<?php echo get_field('project_link'); ?>" target="_blank"><?php echo wp_get_attachment_image( $thumbnail_id, 'full', false, array( 'class' => $thumbnail_class ) ); ?></a>
                                    </div>
                                    <div class="col-span-3">
                                        <p class="text-slate-100">
                                            <a href="<?php echo get_field('project_link'); ?>" target="_blank"><?php echo get_the_title(); ?></a>
                                        </p>
                                        <p class="prose-sm">
